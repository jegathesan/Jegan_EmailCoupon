 ...
 */
/**
 * Email Coupon admin grid block
 *
 * @category    JEGAN
 * @package     JEGAN_EmailCoupon
 * @author      Ultimate Module Creator
 */
class JEGAN_EmailCoupon_Block_Adminhtml_Emailcoupon_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
     ...
     *
     * @access protected
     * @return JEGAN_EmailCoupon_Block_Adminhtml_Emailcoupon_Grid
     * @author Ultimate Module Creator
     */
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()
            ...
            ->where("main_table.reason in (1,2,3)");
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            'reason',
            array(
                'header'    => Mage::helper('jegan_emailcoupon')->__('Reason'),
                'align'     => 'left',
                'index'     => 'reason',
                'type'  => 'options',
                'options' => Mage::helper('jegan_emailcoupon')->convertOptions(
                    Mage::getModel('jegan_emailcoupon/emailcoupon_attribute_source_reason')->getAllOptions()
                )
            )
        );
        ...
        $this->addColumn(
            'used',
            array(
                'header' => Mage::helper('jegan_emailcoupon')->__('Used'),
                'index'  => 'times_used',
                'type'    => 'options',
                'options'    => array(
                    '1' => Mage::helper('jegan_emailcoupon')->__('Yes'),
                    '0' => Mage::helper('jegan_emailcoupon')->__('No'),
                )
    ...
    protected function _preparingMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('emailcoupon');
        ...
        $this->getMassactionBlock()->addItem(
            'customerid',
            array(
                'label'      => Mage::helper('jegan_emailcoupon')->__('Change Customer Name'),
                'url'        => $this->getUrl('*/*/massCustomerid', array('_current'=>true)),
                'additional' => array(
                    'flag_customerid' => array(
                        'name'   => 'flag_customerid',
                        'type'   => 'select',
                        'class'  => 'required-entry',
                        'label'  => Mage::helper('jegan_emailcoupon')->__('Customer Name'),
                        'values' => Mage::getModel('jegan_emailcoupon/emailcoupon_attribute_source_customerid')
                            ->getAllOptions(true),
        ...
        $this->getMassactionBlock()->addItem(
            'coupon_rule_id',
            array(
                'label'      => Mage::helper('jegan_emailcoupon')->__('Change Coupon Name'),
                'url'        => $this->getUrl('*/*/massCouponruleid', array('_current'=>true)),
                'additional' => array(
                    'flag_couponruleid' => array(
                        'name'   => 'flag_couponruleid',
                        'type'   => 'select',
                        'class'  => 'required-entry',
                        'label'  => Mage::helper('jegan_emailcoupon')->__('Coupon Rule Name'),
                        'values' => Mage::getModel('jegan_emailcoupon/emailcoupon_attribute_source_couponruleid')
                            ->getAllOptions(true),
        ...
        $this->getMassactionBlock()->addItem(
            'used',
            array(
                'label'      => Mage::helper('jegan_emailcoupon')->__('Change Used'),
                'url'        => $this->getUrl('*/*/massUsed', array('_current'=>true)),
                'additional' => array(
                    'flag_used' => array(
                        'name'   => 'flag_used',
                        'type'   => 'select',
     ...
     *
     * @access public
     * @param JEGAN_EmailCoupon_Model_Emailcoupon
     * @return string
     * @author Ultimate Module Creator
     */
     ...
     *
     * @access protected
     * @param JEGAN_EmailCoupon_Model_Resource_Emailcoupon_Collection $collection
